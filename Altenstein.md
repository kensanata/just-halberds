...
This is a setting for a short campaign of *Helmbarten* or *Halberts*. The situation generator produces German output but the actual game is played in English, which is why all the extra prep happens in English. The rules suggest the following setup: a dozen people, in three secret societies, three castles, three temples, three magic school, each of them with names and headquarters, each of the people and organisations want three things each, and offer three rewards. That’s a lot of prep.

I used a situation generated by the [Helmbarten Generator](https://campaignwiki.org/helmbarten/), in German, created a map to go along with it, added a ruin or two mentioned in the various jobs descriptions of the non-player characters, worked out some goals they might have, and so on. I think the map can be given to players as-is. There's no point keeping the various locations a secret.

⚠ The generator produced a bunch of non-player characters and none of them has Healing-3, and that means mortal wounds cannot be treated. Having two attributes drop to zero is deadly.
